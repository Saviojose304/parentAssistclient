...
function MedSellerProfileUpdate() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://15.206.80.235:9000/getSellerData', { params: { user_child_id } });
    ...
    const handleGeneralData = async (e) => {
        ...
        try {
            const response = await axios.put('https://15.206.80.235:9000/Sellerprofileupdate', { name, address, phone, user_child_id });
                            ...
                            <div className="tab-content">
                                <div className={isshowgeneral ? 'tab-pane fade active show' : 'tab-pane fade'}>
                                    ...
                                    <div className="">
                                        ...
                                        <textarea className="edit_pro px-4" placeholder="Enter your address" name="address" value={address} onChange={handleaddress} required></textarea>
...
export default MedSellerProfileUpdate;