...
function DoctorBooking() {
    ...
    useEffect(() => {
        ...
        axios.get("https://15.206.80.235:9000/doctorslist")
            .then((response) => {
    ...
    useEffect(() => {
        if (doctorid) { // Check if doctorid is truthy
            axios.get(`https://15.206.80.235:9000/doctorslist/${doctorid}`).then((response) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editMode) {
                ...
                const response = await axios.put(`https://15.206.80.235:9000/updatedoctorbooking/${doctorDetails.doctor_id}/${appointmentDetails.formatted_date}`,
                    {
                        selectedDate,
                        time,
                        gender,
                ...
                const response = await axios.post('https://15.206.80.235:9000/doctorbooking', { selectedDate, time, gender, doctorid });
