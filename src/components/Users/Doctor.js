...
function Doctor() {
    ...
    const fetchParents = async () => {
        try {
            ...
            const response = await fetch(`https://15.206.80.235:9000/DoctorViewParents?userId=${doctor_user_id}`);
            if (response.ok) {
    ...
    const fetchTodaysAppointments = async () => {
        try {
            ...
            const response = await fetch(`https://15.206.80.235:9000/DoctorViewAppointments?userId=${doctor_user_id}&date=${currentDate}`);
            if (response.ok) {
                const data = await response.json();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://15.206.80.235:9000/saveLeaveDays', {
                method: 'POST',
                headers: {
