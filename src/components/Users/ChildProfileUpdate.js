...
function ChildProfileUpdate() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://13.233.162.230:9000/getUserData', { params: { user_child_id }});
    ...
    const handleGeneralData = async (e) => {
        ...
        try {
            const response = await axios.put('https://13.233.162.230:9000/Childprofileupdate',{name, address, phone, user_child_id});
...
export default ChildProfileUpdate;