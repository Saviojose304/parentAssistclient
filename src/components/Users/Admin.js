...
function Admin() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://15.206.80.235:9000/users');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://15.206.80.235:9000/send-terms-email', {
                                                    ...
                                                    {user.user_status === 'ACTIVE' ? (
                                                        <button
                                                            ...
                                                            onClick={async () => {
                                                                ...
                                                                if (confirmed) {
                                                                    ...
                                                                    const response = await axios.post(`https://15.206.80.235:9000/deactivateUser/${user.user_id}`);
                                                                    if (response.status === 200) {
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={async () => {
                                                                ...
                                                                if (confirmed) {
                                                                    // Make an API request to deactivate the user
                                                                    const response = await axios.post(`https://15.206.80.235:9000/activateUser/${user.user_id}`);
                                                                    if (response.status === 200) {
                                                                        // Update the UI or handle success as needed
