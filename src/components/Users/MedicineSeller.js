...
function MedicineSeller() {
    ...
    const fetchMedicineDetails = async () => {
        try {
            const response = await axios.get(`https://15.206.80.235:9000/sellerMedicineView/${seller_user_id}`);
            ...
            try {
                if (isEditMode && editedMedicine) {
                    ...
                    const response = await axios.put(
                        `https://15.206.80.235:9000/updateMedicine/${editedMedicine}`,
                        {
                            expiryDate: date,
                        }
                    );
                    ...
                    const response = await axios.post('https://15.206.80.235:9000/addMedicine', {
                        name: medicinename,
                        expiryDate: date,
